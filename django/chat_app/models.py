...
class Profile(models.Model):
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="profile_detail"
    )
    """
       Add other fields...
    """
...
class ChatSession(models.Model):
    user1 = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user1_name"
    )
    user2 = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user2_name"
    )
...
class ChatMessage(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        ChatSession.objects.get(
            id=self.chat_session.id
        ).save()  # Update ChatSession TimeStampe
